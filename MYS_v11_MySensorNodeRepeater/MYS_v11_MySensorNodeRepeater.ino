...
void setup()
{
  ...
  */
  #ifdef NODE_ID
  //The true sets repeater mode to true
  node.begin(NULL,NODE_ID,true);
  #else
  ...
  node.sendSketchInfo("mys_v11-sensor-repeater", "0.5");
...
void loop() 
{
  ...
  //Also calles process() in background while waiting
